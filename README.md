...
- 验收时间：12月30号下午2点开始，每组10分钟左右，顺序按照组号从大到小
...
- 关于验收分数：
  ...
  `现场测试`环节需要大家根据要求实现一条额外的指令，题目我会在30号10：30大家考完期末考试时发布。该指令没有功能测试程序，大家在验收时根据改动的代码向我阐述思路即可。（如果代码都是自己完成的那这个任务半个小时左右就能解决，所以大家不用担心先验收的会在此项有劣势）
